...
const News = (props) => {
   ...
   const updateNews =  async () => {
    ...
    const fetchMoreData = async () => {
        ...
        return (
            <>
                <h1 className="text-center" style={{ margin: '35px 0px',marginTop: '90px',color: props.mode == 'light' ? 'black' : 'white' }}>NewsMonkey - Top {capitalizeFirstLetter(props.category)} Headlines</h1>
                {loading && <Spinner />}
                <InfiniteScroll
